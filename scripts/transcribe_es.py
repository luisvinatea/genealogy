...
# 1) Path to the *Spanish* Vosk model:
MODEL_PATH = "/home/luisvinatea/Dev/Repos/genealogy/tools/vosk-model-small-es-0.42"  # Update path
...
def main():
    ...
    with sd.RawInputStream(
        ...
        print("Spanish transcription running. Press Ctrl+C to stop.")
        ...
        while True:
            ...
            if recognizer.AcceptWaveform(resampled_bytes):
                ...
                print(f"\r[Español - Parcial] {partial_text}", end='', flush=True)

if __name__ == "__main__":
    try:
        main()
    except KeyboardInterrupt:
        print("\nSaliendo de la transcripción en español...")
